...
//   - ClockSkew: Anger tillåten tidsmarginal mellan klient och server. Håll denna låg i demo (t.ex. 1 minut).
builder.Services
    ...
    .AddJwtBearer(options =>
    {
        ...
        options.TokenValidationParameters = new TokenValidationParameters
        {
            ...
            // FIX: Lägg till strikt livstidskontroll och liten tidsmarginal för tydligare beteende.
